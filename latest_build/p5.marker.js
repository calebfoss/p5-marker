// p5-marker v0.0.0 Sat Jan 14 2023 https://github.com/calebfoss/p5-marker.git
...
const $7a53813bc2528edd$export$f38e744fd7a17882 = (camelStr) =>
  camelStr
    .replace(
      $7a53813bc2528edd$var$upperCaseCharAfterFirst,
      $7a53813bc2528edd$var$prependMatch("-")
    )
    .toLowerCase();
const $7a53813bc2528edd$export$e12f55f9c91df96a = (camelStr) =>
  camelStr
    .replace(
      $7a53813bc2528edd$var$upperCaseCharAfterFirst,
      $7a53813bc2528edd$var$prependMatch("_")
    )
    .toLowerCase();
const $7a53813bc2528edd$export$fd546b5ffd1f6a92 = (kebabStr) =>
  kebabStr.replace(/-./g, (s) => s[1].toUpperCase());
const $7a53813bc2528edd$export$1e3da36a069282b8 = (pascalStr) =>
  pascalStr.slice(0, 1).toLowerCase() + pascalStr.slice(1);
const $7a53813bc2528edd$export$b797531657428303 = (pascalStr) =>
  $7a53813bc2528edd$export$1e3da36a069282b8(pascalStr).replaceAll(
    $7a53813bc2528edd$var$upperCaseChar,
    (c) => "-" + c.toLowerCase()
  );
const $7a53813bc2528edd$export$c41e01cfc9033fe7 = (pascalStr) =>
  $7a53813bc2528edd$export$1e3da36a069282b8(pascalStr).replaceAll(
    $7a53813bc2528edd$var$upperCaseChar,
    (c) => "_" + c.toLowerCase()
  );
const $7a53813bc2528edd$export$b70dcce1c70696bf = (snakeStr) =>
  snakeStr
    .split("_")
...
const $1e4b072929c69c2b$var$notProceededByOpenString =
  "(?=(?:[^\"'`](?:([\"'`]).*\\1)*)*$)";
const $1e4b072929c69c2b$var$varName = new RegExp(
  $1e4b072929c69c2b$var$notExistingObjProp +
    $1e4b072929c69c2b$var$legalVarName +
    $1e4b072929c69c2b$var$notNewObjProp +
    $1e4b072929c69c2b$var$notBoolean +
    $1e4b072929c69c2b$var$notNewKeyword +
    $1e4b072929c69c2b$var$notProceededByOpenString,
  "gi"
);
class $1e4b072929c69c2b$export$25a3dda2d7b8a35b {
  ...
  static getOwnerName(el, prop) {
    if (
      $1e4b072929c69c2b$export$25a3dda2d7b8a35b.keywords.includes(prop) ||
      prop in $1e4b072929c69c2b$export$25a3dda2d7b8a35b.escapes ||
      prop in globalThis
    )
      return "none";
  ...
  static getPrefix(el, prop) {
    const ownerName = $1e4b072929c69c2b$export$25a3dda2d7b8a35b.getOwnerName(
      el,
      prop
    );
  ...
  static replacePropName(el, prop) {
    if (prop in $1e4b072929c69c2b$export$25a3dda2d7b8a35b.escapes)
      return $1e4b072929c69c2b$export$25a3dda2d7b8a35b.escapes[prop];
  ...
  static replacePropNames(el, str) {
    return str
      .replace(/UNTIL(.*)/, "!($1)")
      .replace(
        $1e4b072929c69c2b$export$25a3dda2d7b8a35b.regex.varName,
        (prop) =>
          $1e4b072929c69c2b$export$25a3dda2d7b8a35b.replacePropName(el, prop)
      );
  }
}
...
const $1b3618ac1b6555cf$export$e00416b3cd122575 = (methodName, wrapper) =>
  (p5.prototype[methodName] = wrapper(p5.prototype[methodName]));
const $1b3618ac1b6555cf$export$49218a2feaa1d459 = (...propNames) =>
  propNames.forEach(
    (propName) =>
      (p5.prototype[(0, $7a53813bc2528edd$export$e12f55f9c91df96a)(propName)] =
        p5.prototype[propName])
  );
const $1b3618ac1b6555cf$export$44f806bc073ff27e = (...methodNames) =>
  methodNames.forEach((methodName) =>
    $1b3618ac1b6555cf$export$b61bda4fbca264f2({
...
(0, $1b3618ac1b6555cf$export$e00416b3cd122575)(
...
p5.prototype.assignCanvas = function (c, r) {
  ...
  //P2D mode
  else this._setProperty("_renderer", new p5.Renderer2D(c, this, true));
...
const $641a8979c6a6229d$var$P5Extension = (baseClass) =>
  class P5Extension extends baseClass {
     ...
     */ get orderedAttributeNames() {
      const ordered = Array.from(this.attributes)
        .sort(
          ({ name: a }, { name: b }) =>
            ($641a8979c6a6229d$var$attributePriorities.indexOf(a) + 1 ||
              $641a8979c6a6229d$var$attributePriorities.indexOf("_default")) -
            ($641a8979c6a6229d$var$attributePriorities.indexOf(b) + 1 ||
              $641a8979c6a6229d$var$attributePriorities.indexOf("_default"))
        )
        .map(({ name: name }) => name);
      this.transformDoneIndex =
        ordered.findLastIndex((attrName) =>
          $641a8979c6a6229d$var$attributePriorities.includes(attrName)
        ) + 1;
      return ordered;
    }
    /**
     ...
     */ #setupEvalFn(attr) {
      ...
      if (
        (0, $1e4b072929c69c2b$export$25a3dda2d7b8a35b).allQuotesMatched(
          attrJsStr
        ) === false
      )
        console.error(
      ...
      const owner = (0, $1e4b072929c69c2b$export$25a3dda2d7b8a35b).getOwnerName(
        this,
        attr.name
      );
      ...
      //  Ex:  myArray[i]
      const varName = (0,
      $1e4b072929c69c2b$export$25a3dda2d7b8a35b).replacePropNames(
        this,
        attr.name
      );
      const attrValueVarsReplaced = (0,
      $1e4b072929c69c2b$export$25a3dda2d7b8a35b).replacePropNames(
        this,
        attrJsStr
      );
      const varValue = (0, $1e4b072929c69c2b$export$25a3dda2d7b8a35b).enclose(
        attrValueVarsReplaced
      );
     ...
     */ #setupEvalFns() {
      ...
      const {
        orderedAttributeNames: orderedAttributeNames,
        transformDoneIndex: transformDoneIndex,
      } = this;
     ...
     */ #updateAttribute(inherited1, attrName1, thisArg1) {
      if (attrName1 === "repeat" || attrName1 === "change")
        inherited1 = this.#state;
      ...
      if (
        ...
        (attrName1 !== "width" || attrName1 !== "height")
      )
        return val;
...
class $641a8979c6a6229d$export$82fefa1d40d42487 extends $641a8979c6a6229d$var$P5Extension(
  HTMLElement
) {}
class $641a8979c6a6229d$export$d546242e33fb8131 extends $641a8979c6a6229d$export$82fefa1d40d42487 {
  constructor(overloads, renderFunctionName) {
     ...
     */ this.renderFunctionName =
      renderFunctionName ||
      (0, $7a53813bc2528edd$export$fd546b5ffd1f6a92)(
   ...
   */ setupRenderFunction() {
    ...
    this.render = function () {
      this.pInst[this.renderFunctionName](
        ...args.map(({ param: param, owner: owner }) => owner[param])
      );
    };
  }
}
p5.prototype._defineCustomElement = function (pCustomEl) {
  ...
  customElements.define(
    `p-${name}`,
    class extends $641a8979c6a6229d$export$82fefa1d40d42487 {
      constructor() {
        super();
      }
      /**
 ...
 */ class $641a8979c6a6229d$var$Canvas extends $641a8979c6a6229d$var$P5Extension(
  HTMLCanvasElement
) {
  constructor() {
    super();
...
class $641a8979c6a6229d$var$Asset extends HTMLElement {
  ...
  async load(pInst) {
    ...
    const loadFn =
      $641a8979c6a6229d$var$Asset.loadFns[
 ...
 */ class $641a8979c6a6229d$var$Sketch extends HTMLLinkElement {
  ...
  #convertAllElements(xmlEl1, parent = document.body) {
    ...
    for (let i1 = 0; i1 < xmlEl1.children.length; i1++)
      this.#convertAllElements(xmlEl1.children[i1], pEl1);
  }
  #convertXML(e) {
  ...
  #xmlTagToCreateElementArguments(xmlTag1) {
    if (xmlTag1.slice(0, 2) === "p-") return [xmlTag1];
    if (xmlTag1 === "canvas")
      return [
        xmlTag1,
        {
...
class $be018c00eb40bc53$export$f08b370029806897 extends (0,
$641a8979c6a6229d$export$d546242e33fb8131) {
  constructor(overloads, renderFunctionName) {
    /**
     * @private
     */ overloads = [
...
(0, $1b3618ac1b6555cf$export$b61bda4fbca264f2)({
  canvas_background: {
    ...
    set: function (val) {
      if (val === this.NONE)
        this._background = $be018c00eb40bc53$var$transparent;
 ...
 */ class $be018c00eb40bc53$var$Clear extends (0,
$641a8979c6a6229d$export$d546242e33fb8131) {
  constructor() {
    super(["", "r, g, b, a"]);
  }
...
/*~++~+~+~++~+~++~++~+~+~ 2D ~+~+~++~+~++~+~+~+~+~+~+~+~+~+~+*/ p5.prototype.collide_rect_rect =
...
const $c7ffc8b66df47534$var$transformVertexFn = (el) => (v) => {
  ...
  const { x: x, y: y } = el.pInst._transform_point_matrix(
    originalPoint,
    el.transform_matrix
  );
 ...
 */ class $c7ffc8b66df47534$var$Arc extends (0,
$641a8979c6a6229d$export$d546242e33fb8131) {
  constructor() {
  ...
  get mouse_over() {
    const {
      mouse_trans_pos_x: mouse_trans_pos_x,
      mouse_trans_pos_y: mouse_trans_pos_y,
    } = this.pInst;
    const {
      x: x,
      y: y,
 ...
 */ class $c7ffc8b66df47534$var$Ellipse extends (0,
$641a8979c6a6229d$export$d546242e33fb8131) {
  constructor() {
  ...
  get collision_args() {
    ...
    const { x: x, y: y } = this.pInst._transform_point_matrix(
      originalPoint,
 ...
 */ class $c7ffc8b66df47534$var$Circle extends (0,
$641a8979c6a6229d$export$d546242e33fb8131) {
  constructor() {
    super(["x, y, d"]);
  }
 ...
 */ class $c7ffc8b66df47534$var$Line extends (0,
$641a8979c6a6229d$export$d546242e33fb8131) {
  constructor() {
 ...
 */ class $c7ffc8b66df47534$var$Point extends (0,
$641a8979c6a6229d$export$d546242e33fb8131) {
  constructor() {
  ...
  get collision_args() {
    ...
    const { stroke_weight: stroke_weight, pixel_density: pixel_density } =
      this.pInst;
 ...
 */ class $c7ffc8b66df47534$var$Quad extends (0,
$641a8979c6a6229d$export$d546242e33fb8131) {
  constructor() {
    super([
  ...
  get collision_args() {
    return [this.vertices.map($c7ffc8b66df47534$var$transformVertexFn(this))];
  }
  get mouse_over() {
    const {
      mouse_trans_pos_x: mouse_trans_pos_x,
 ...
 */ class $c7ffc8b66df47534$var$Rect extends (0,
$641a8979c6a6229d$export$d546242e33fb8131) {
  constructor() {
    super([
      "x, y, w, [h], [tl], [tr], [br], [bl]",
 ...
 * @attr  {Number} br - radius of bottom-right corner.
 * @attr  {Number} bl - radius of bottom-left corner.
 */ class $c7ffc8b66df47534$var$Square extends (0,
$641a8979c6a6229d$export$d546242e33fb8131) {
  constructor() {
...
class $c7ffc8b66df47534$var$Triangle extends (0,
$641a8979c6a6229d$export$d546242e33fb8131) {
  constructor() {
...
class $c7ffc8b66df47534$var$Bezier extends (0,
$641a8979c6a6229d$export$d546242e33fb8131) {
  constructor() {
    super([
...
class $c7ffc8b66df47534$var$Curve extends (0,
$641a8979c6a6229d$export$d546242e33fb8131) {
  constructor() {
    super([
      "x1, y1, x2, y2, x3, y3, x4, y4",
...
class $c7ffc8b66df47534$var$Contour extends (0,
$641a8979c6a6229d$export$d546242e33fb8131) {
  constructor() {
    super([""], "beginContour");
  }
...
class $c7ffc8b66df47534$var$Shape extends (0,
$641a8979c6a6229d$export$d546242e33fb8131) {
  constructor() {
  ...
  get vertices() {
    ...
    const vertexChildren = childArray.filter(
      (el) => el instanceof $c7ffc8b66df47534$var$Vertex && el.this_element
    );
...
class $c7ffc8b66df47534$var$Vertex extends (0,
$641a8979c6a6229d$export$d546242e33fb8131) {
  constructor() {
...
class $c7ffc8b66df47534$var$QuadraticVertex extends (0,
$641a8979c6a6229d$export$d546242e33fb8131) {
  constructor() {
...
customElements.define(
  "p-quadratic-vertex",
  $c7ffc8b66df47534$var$QuadraticVertex
);
class $c7ffc8b66df47534$var$CurveVertex extends (0,
$641a8979c6a6229d$export$d546242e33fb8131) {
  constructor() {
    super(["x, y", "x, y, [z]"]);
  }
...
class $c7ffc8b66df47534$var$Normal extends (0,
$641a8979c6a6229d$export$d546242e33fb8131) {
  constructor() {
    super(["vector", "x, y, z"]);
  }
...
class $c7ffc8b66df47534$var$Plane extends (0,
$641a8979c6a6229d$export$d546242e33fb8131) {
  constructor() {
...
class $c7ffc8b66df47534$var$Box extends (0,
$641a8979c6a6229d$export$d546242e33fb8131) {
  constructor() {
...
class $c7ffc8b66df47534$var$Sphere extends (0,
$641a8979c6a6229d$export$d546242e33fb8131) {
  constructor() {
...
class $c7ffc8b66df47534$var$Cylinder extends (0,
$641a8979c6a6229d$export$d546242e33fb8131) {
  constructor() {
...
class $c7ffc8b66df47534$var$Cone extends (0,
$641a8979c6a6229d$export$d546242e33fb8131) {
  constructor() {
...
class $c7ffc8b66df47534$var$Ellipsoid extends (0,
$641a8979c6a6229d$export$d546242e33fb8131) {
  constructor() {
...
class $c7ffc8b66df47534$var$Torus extends (0,
$641a8979c6a6229d$export$d546242e33fb8131) {
  constructor() {
...
class $c7ffc8b66df47534$var$LoadModel extends (0,
$641a8979c6a6229d$export$d546242e33fb8131) {
  constructor() {
    super([
...
class $c7ffc8b66df47534$var$Model extends (0,
$641a8979c6a6229d$export$d546242e33fb8131) {
  constructor() {
    super(["model"]);
  }
...
const $c7ffc8b66df47534$var$pointTangentOverload = (fn) =>
  function () {
...
p5.prototype.bezierPoint = $c7ffc8b66df47534$var$pointTangentOverload(
  p5.prototype.bezierPoint
);
p5.prototype.bezierTangent = $c7ffc8b66df47534$var$pointTangentOverload(
  p5.prototype.bezierTangent
);
p5.prototype.curvePoint = $c7ffc8b66df47534$var$pointTangentOverload(
  p5.prototype.curvePoint
);
p5.prototype.curveTangent = $c7ffc8b66df47534$var$pointTangentOverload(
  p5.prototype.curveTangent
);
p5.prototype.yesSmooth = p5.prototype.smooth;
(0, $1b3618ac1b6555cf$export$44f806bc073ff27e)(
  "ellipseMode",
  "rectMode",
  "curveTightness"
);
...
(0, $1b3618ac1b6555cf$export$49218a2feaa1d459)(
  "selectAll",
  "removeElements",
  "createDiv",
  "createP",
...
const $3d1b09cc8252f1f2$var$wrap = function (renderer) {
  function wrappedRenderer() {
    ...
    this._anchorStack = [$3d1b09cc8252f1f2$var$defaultAnchor.copy()];
    this._angleStack = [$3d1b09cc8252f1f2$var$defaultAngle.copy()];
    this._scaleStack = [$3d1b09cc8252f1f2$var$defaultScale.copy()];
    this._shearStack = [$3d1b09cc8252f1f2$var$defaultShear.copy()];
  }
...
(0, $1b3618ac1b6555cf$export$e00416b3cd122575)(
  ...
  (base) =>
    function () {
      this._renderer._anchorStack.push(
        $3d1b09cc8252f1f2$var$defaultAnchor.copy()
      );
      this._renderer._angleStack.push(
        $3d1b09cc8252f1f2$var$defaultAngle.copy()
      );
      this._renderer._scaleStack.push(
        $3d1b09cc8252f1f2$var$defaultScale.copy()
      );
      this._renderer._shearStack.push(
...
p5.prototype._transform_point_matrix = function (originalPoint, transMatrix) {
  const pixelDensityMatrix = new DOMMatrix(
    $3d1b09cc8252f1f2$var$identityMatrix
  ).scale(this.pixel_density);
 ...
 */ class $d41e5f38852d70c7$var$Image extends (0,
$641a8979c6a6229d$export$d546242e33fb8131) {
  constructor() {
    super([
      "img, x, y, [w], [h]",
...
class $aeaf4bbafe4a9ee3$var$Text extends (0,
$641a8979c6a6229d$export$d546242e33fb8131) {
  constructor() {
 ...
 */ class $da8d19ba6ae4969b$var$AmbientLight extends (0,
$be018c00eb40bc53$export$f08b370029806897) {
  constructor() {
    super([]);
  }
}
 ...
 *                                 href="https://p5js.org/reference/#/p5.Color"
 *                                 target="_blank">p5.Color</a>
 */ class $da8d19ba6ae4969b$var$DirectionalLight extends (0,
$641a8979c6a6229d$export$d546242e33fb8131) {
  constructor() {
    super([
      "v1, v2, v3, x, y, z",
...
customElements.define(
  "p-directional-light",
  $da8d19ba6ae4969b$var$DirectionalLight
);
/**
 ...
 */ class $da8d19ba6ae4969b$var$PointLight extends (0,
$641a8979c6a6229d$export$d546242e33fb8131) {
  constructor() {
    super([
      "v1, v2, v3, x, y, z",
 ...
 * @element lights
 */ class $da8d19ba6ae4969b$var$Lights extends (0,
$641a8979c6a6229d$export$d546242e33fb8131) {
  constructor() {
    super([""]);
  }
 ...
 *                                            100
 */ class $da8d19ba6ae4969b$var$SpotLight extends (0,
$641a8979c6a6229d$export$d546242e33fb8131) {
  constructor() {
    super([
...
("use strict");
const $cf838c15c8b009ba$var$customElementsDefined = new Event(
